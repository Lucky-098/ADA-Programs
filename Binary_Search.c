...
// function of generation of Sorted array
...
int main() {
    ...
    for (int s = 0; s < num_sizes; s++) {
        ...
        long iterations = (50000000 / (int)log2(n)) + 1000;
        if (iterations < 100000) iterations = 100000;

        // Time measurement start
        clock_t start = clock();

        // Optimization prevent
        int dummy = 0;
        ...
        double log2n = log2(n); // unused variable 'log2n' [-Wunused-variable]
